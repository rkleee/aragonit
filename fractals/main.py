...
class MainWindow(qw.QWidget):
        ...
        def __init__(self):
                ...
                self.functions=["z=z^2+c","z=2/3*(z^3-2)/z","z=sinh(z)+c","z=z-11/12*(z^3-1)","z=z-11/12(z^3-1)-1/10*c","z=z^2-0.2-0.7i","z=z^2-0.742+0.1j"]
                ...
                self.colorSchema=["rainbow","spring","autumn","viridis","magma","Greens","YlOrBr","YlGnBu","BrBG","Spectral","bwr"]
        ...
        def draw(self):
                ...
                self.fractal=FractalWidget(start,end,functionIndex,zoom,functionText,col)
